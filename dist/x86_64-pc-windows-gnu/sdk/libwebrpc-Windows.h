...
//
extern __declspec(dllexport) GoUintptr WebrpcClient_New(char* token, char* passwd, char* permission);

// 检查登录状态
//
extern __declspec(dllexport) int WebrpcClient_LoginStatus(GoUintptr handle);

// 获取会独爱tcp端口号
//
extern __declspec(dllexport) int WebrpcClient_GetReceivePort(GoUintptr handle);
...
// 关闭客户端
//
extern __declspec(dllexport) void WebrpcClient_Free(GoUintptr handle);
